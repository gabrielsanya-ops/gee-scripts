// Burn severity mapping using NBR. Imports: geometry = Table users/gabrielsanya/ke_pol
...
var legendTitle = ui.Label({ value: 'dNBR Classes', style: { fontWeight: 'bold', fontSize: '18px', margin: '0 0 4px 0', padding: '0' } });
...
var palette = ['7a8737', 'acbe4d', '0ae042', 'fff7eb', 'ffaf38', 'ff641b', 'a41fd6', 'ffffff'];
...
for (var i = 0; i < 8; i++) { legend.add(makeRow(palette[i], names[i])); }
Map.add(legend);
